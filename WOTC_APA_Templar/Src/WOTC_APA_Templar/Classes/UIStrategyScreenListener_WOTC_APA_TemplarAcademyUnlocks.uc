...
class UIStrategyScreenListener_WOTC_APA_TemplarAcademyUnlocks extends UIStrategyScreenListener;
...
event OnInit(UIScreen Screen)
{
    if (IsInStrategy())
    {
		...
		AddSoldierUnlockTemplate('OfficerTrainingSchool', 'WOTC_APA_TemplarUnlock1');
		AddSoldierUnlockTemplate('OfficerTrainingSchool', 'WOTC_APA_TemplarUnlock2');
	}
}
